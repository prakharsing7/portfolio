...
export const ROLLS: Roll[] = [
  {
    ...
    frames: [
      ...
      f('lazy250-dharamshala-13', 2400, 1599, 'Prayer flags over a festival crowd, Dharamshala'),
      f('lazy250-dharamshala-05', 2400, 1599, 'Cherry blossoms over the valley, Dharamshala'),
      f('lazy250-dharamshala-11', 1599, 2400, 'Amphitheatre steps in the forest, Dharamshala'),
      f('lazy250-dharamshala-07', 2400, 1599, 'A candid portrait, Dharamshala'),
      f('lazy250-dharamshala-02', 2400, 1599, 'Hillside town and school grounds, Dharamshala'),
      f('lazy250-dharamshala-08', 2400, 1599, 'A prayer-flag-draped shrine, Dharamshala'),
      f('lazy250-dharamshala-12', 2400, 1599, 'A Tibetan-style building among trees, Dharamshala'),
      f('lazy250-dharamshala-03', 2400, 1599, 'Looking up a terraced wall, Dharamshala'),
      f('lazy250-dharamshala-14', 2400, 1599, 'A town square, Dharamshala'),
      f('lazy250-dharamshala-10', 2400, 1599, 'An alley of wires and rooftops, Dharamshala'),
    ],
  },
  {
    id: 'ilford-xp2',
