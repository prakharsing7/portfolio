...
export const metadata: Metadata = {
  title: 'About',
  description:
    'AI & Backend Engineer at Electric Miles, London. From ML research roots through iOS development to EV infrastructure and AI integration.',
}
        ...
        <div className="flex-1 max-w-content">
          <div className="space-y-5 text-body text-text-secondary mb-14">
            <p>
              ...
              INSAT-3D satellite imagery. The hypothesis: convolutional nets applied to raw geoTIFF
              frames could yield faster, more granular predictions. It worked, and reinforced a way
              of thinking I still carry: physical systems as data problems.
            </p>
            <p>
          ...
          <div className="space-y-5 text-body text-text-secondary mb-14">
            <p>
              ...
              architecture and a MongoDB backend. Ten-plus screens, collaborative editing, real-time
              sync. An iOS internship at Infosys. A hospital management system (zen-u). An
              open-source 3D slicer fork (slic3r).
            </p>
            <p>
              The pattern: full-stack capability, product ownership, cross-platform range. The
              discipline of shipping something complete. The distance between &ldquo;it works&rdquo;
              and &ldquo;it feels right&rdquo;, and learning to close it deliberately.
            </p>
          </div>
          ...
          <div className="space-y-5 text-body text-text-secondary">
            <p>
              ...
              field values, undocumented edge cases. You learn fast that a protocol spec and a real
              charger are two different things.
            </p>
            <p>
              Then: full end-to-end test ownership of emPACT, Electric Miles&rsquo; flagship B2B
              platform for CPOs and fleet operators. State machine coverage for every charger type.
              Payment flow edge cases. Load balancing scenarios.
            </p>
            <p>
