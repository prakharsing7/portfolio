...
date: 2026-01-15
excerpt: 'Manufacturers are a pain to put it simply. Every charger has custom fields, non-standard status code and undocumented edge cases.'
---

The assumption is that OCPP is an open standard. Therefore, integrating a new charger should be a matter of following the spec and that the charger would adhere to the said spec.
