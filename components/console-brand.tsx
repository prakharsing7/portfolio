...
export function ConsoleBrand() {
  useEffect(() => {
    const badge =
      'background:#00E5A0;color:#080808;font-family:monospace;font-weight:700;padding:4px 10px;border-radius:2px'
    const name =
      'background:#101010;color:#F0F0F0;font-family:monospace;padding:4px 10px;border:1px solid #1C1C1C'
